...
/* package dummy-package-0.1.0.0 */
#ifndef VERSION_dummy_package
#define VERSION_dummy_package "0.1.0.0"
#endif /* VERSION_dummy_package */
#ifndef MIN_VERSION_dummy_package
#define MIN_VERSION_dummy_package(major1,major2,minor) (\
  (major1) <  0 || \
  (major1) == 0 && (major2) <  1 || \
  (major1) == 0 && (major2) == 1 && (minor) <= 0)
#endif /* MIN_VERSION_dummy_package */
...
#define CURRENT_COMPONENT_ID "dummy-package-0.1.0.0-8PxeXlpSG9RLHMD7OlPTXv-dummy-package"
